...
db_sync_performance_logfile="logs/db_sync_performance.log"
...
do
	...
	echo "latest_db_synced_slot: $latest_db_synced_slot" | tee -a $db_sync_performance_logfile
    echo "======================================================" | tee -a $db_sync_performance_logfile
    echo "RAM Usage:" | tee -a $db_sync_performance_logfile
    free -h | tee -a $db_sync_performance_logfile
    echo "Disk Usage:" | tee -a $db_sync_performance_logfile
    df -h | tee -a $db_sync_performance_logfile
    echo "CPU Usage:" | tee -a $db_sync_performance_logfile
    mpstat | tee -a $db_sync_performance_logfile
done
